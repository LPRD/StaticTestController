...
{
	private:
		struct gpiod_chip *chipClk;
		struct gpiod_chip *chipDat;
		struct gpiod_line *PD_SCK;	// Power Down and Serial Clock Input Pin
		struct gpiod_line *DOUT;	// Serial Data Output Pin
